...
class ResourceManager:
    ...
    def __init__(self):
        ...
        # Configuration
        self.lollms_url = os.getenv("LOLLMS_URL", "http://localhost:9600")
        self.lollms_model = os.getenv("LOLLMS_MODEL_NAME", "mistral")
        self.fish_speech_url = os.getenv("FISH_SPEECH_API_URL", "http://localhost:8080/v1/tts")
    ...
    def get_lollms_client(self) -> Optional[LollmsClient]:
        ...
        def _loader():
            try:
                ...
                logger.warning(f"Could not initialise LollmsClient: {e}")
                return None
